/****** Object:  TableFunction [dbo].[LayoutSQLParts_BKI]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE function dbo.LayoutSQLParts_BKI
(
		...
		declare @BKICombName varchar(25) = ''
		 ...
		 DECLARE TransTempCol CURSOR FOR
			...
			SELECT 	1 OrdCtl, OutOrder
				...
				union
				select 2 OrdCtl, RecID
						, ttc.SourceCode + ' [_Key_' + ttc.OutName + ']' FldSrc, RecID * -1 RecID
						, '[' + ttc.OutName+ ']' OutName
