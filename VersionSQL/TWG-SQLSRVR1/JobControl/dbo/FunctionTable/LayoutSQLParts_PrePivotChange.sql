/****** Object:  TableFunction [dbo].[LayoutSQLParts_PrePivotChange]    Committed by VersionSQL https://www.versionsql.com ******/

Create function dbo.LayoutSQLParts_PrePivotChange
(
...
Begin
	...
	declare @FldSrc varchar(1000), @FldID int, @LayoutFieldSrc varchar(1000), @OutName varchar(1000)
	...
	if @JobStepID is not null
		...
		declare @BKICombName varchar(25) = ''
		 ...
		 FETCH NEXT FROM TransTempCol into @OrdA, @OrdB, @FldSrc, @FldID, @OutName
