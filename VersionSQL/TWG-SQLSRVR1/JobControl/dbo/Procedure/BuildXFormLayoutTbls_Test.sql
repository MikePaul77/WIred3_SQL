/****** Object:  Procedure [dbo].[BuildXFormLayoutTbls_Test]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE dbo.BuildXFormLayoutTbls_Test @JobStepID int, @FieldMode varchar(20), @debug bit
as
BEGIN
	SET NOCOUNT ON;
