/****** Object:  Procedure [dbo].[CleanUpPreviousJobRunRemnants]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE dbo.CleanUpPreviousJobRunRemnants @JobID int
AS
BEGIN
	SET NOCOUNT ON;
