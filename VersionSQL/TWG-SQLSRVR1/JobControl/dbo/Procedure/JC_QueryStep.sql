/****** Object:  Procedure [dbo].[JC_QueryStep]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE dbo.JC_QueryStep @JobStepID int
AS
BEGIN
	SET NOCOUNT ON;
	...
	select @QueryParamVersion = coalesce(QueryParamVersion,@DefaultQueryParamVersion)
