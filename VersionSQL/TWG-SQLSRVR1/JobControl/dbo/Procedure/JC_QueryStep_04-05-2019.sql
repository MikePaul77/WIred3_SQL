/****** Object:  Procedure [dbo].[JC_QueryStep_04-05-2019]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE dbo.JC_QueryStep_04-05-2019 @JobStepID int
AS
BEGIN
	SET NOCOUNT ON;
