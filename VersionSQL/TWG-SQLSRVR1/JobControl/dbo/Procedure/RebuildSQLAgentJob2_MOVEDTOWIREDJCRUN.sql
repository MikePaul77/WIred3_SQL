/****** Object:  Procedure [dbo].[RebuildSQLAgentJob2_MOVEDTOWIREDJCRUN]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[RebuildSQLAgentJob2]
	@JobID int
AS
BEGIN
	...
	BEGIN
		...
		SELECT @JobName = j.JobName
				...
				, @RunServer = coalesce(jrs.SQLName,jcs.SQLName,@@Servername)
