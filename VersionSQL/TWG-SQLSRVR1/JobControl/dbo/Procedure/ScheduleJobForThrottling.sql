/****** Object:  Procedure [dbo].[ScheduleJobForThrottling]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE dbo.ScheduleJobForThrottling 
	@JobID int,
	@RunPriority int,
			...
			if @JobStepID=0
				Begin 
					if not exists(	Select ID 
						...
						Insert into JobControl..JobLog(JobID, RunPriority, SQLJobID, CreateUser)
							values(@JobID, @RunPriority, @SQLJobID, @UserID)
				End
			else
				Begin
					if not exists(	Select ID 
