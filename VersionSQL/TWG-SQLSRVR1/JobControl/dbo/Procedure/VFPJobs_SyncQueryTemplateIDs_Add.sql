/****** Object:  Procedure [dbo].[VFPJobs_SyncQueryTemplateIDs_Add]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE dbo.VFPJobs_SyncQueryTemplateIDs_Add @MaxJobID int
AS
BEGIN
	SET NOCOUNT ON;
