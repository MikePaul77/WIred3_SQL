/****** Object:  Table [dbo].[InCase_JobSteps]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE TABLE dbo.InCase_JobSteps(
	...
	[DeliveryListID] [int] NULL,
	[DeliveryNoticeListID] [int] NULL,
	[DeliveryNoticeTemplateID] [int] NULL,
