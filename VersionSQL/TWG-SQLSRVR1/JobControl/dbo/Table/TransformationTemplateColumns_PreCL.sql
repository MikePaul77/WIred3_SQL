/****** Object:  Table [dbo].[TransformationTemplateColumns_PreCL]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE TABLE dbo.TransformationTemplateColumns_PreCL(
